...
using Autofac;
using krdn.Core.ContributorAggregate;
using krdn.Core.Interfaces;
using krdn.Infrastructure.Data;
using krdn.Infrastructure.Data.Queries;
using krdn.Infrastructure.Email;
using krdn.UseCases.Contributors.Create;
using krdn.UseCases.Contributors.List;
using MediatR;
using MediatR.Pipeline;
using Module = Autofac.Module;

namespace krdn.Infrastructure;
/// <summary>
